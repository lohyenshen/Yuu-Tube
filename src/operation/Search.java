...
public class Search{
    public static void main( User currentUser ) throws Exception{
        ...
        // because we have to display statistics for each video played
            ...
            searchVideo(currentUser);
        }
    }
    public static void searchUser( User currentUser ) throws Exception {
        Scanner sc = new Scanner(System.in);
    ...
    public static void searchVideo( User currentUser ) throws Exception{
        Scanner sc = new Scanner(System.in);
